...
Медианой непрерывной случайной величины X называется такое ее значение mx, для которого

![Alt text](/mediana.png?raw=true "mediana")

одинаково вероятно, окажется ли случайная величина X меньше mx или больше mx.
